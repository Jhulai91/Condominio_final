...
public class UsuarioController {
	...
	public String registrar(@ModelAttribute Usuario usuario, @RequestParam("cedula") String cedula,
			@RequestParam("telefono") String telefono, @RequestParam("rol") String rol, Model model) {
	...
	//	return "redirect:/forgotPassword"; // Nombre de tu plantilla Thymeleaf para recuperar contraseña
	//}
	...
	public String processForgotPassword(@RequestParam("email") String email, RedirectAttributes redirectAttributes) {
		...
		if (usuario != null) {
			try {
				// Obtenemos la contraseña directamente del objeto Usuario
				String contrasena = usuario.getPassword();
				emailService.enviarContrasena(usuario.getEmail(), usuario.getNombre(), contrasena);
				redirectAttributes.addFlashAttribute("successMessage",
						"Si el correo existe, la contraseña ha sido enviada.");
			} catch (Exception e) {
				redirectAttributes.addFlashAttribute("errorMessage",
						"Error al enviar el correo. Inténtelo de nuevo más tarde.");
